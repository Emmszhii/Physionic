    ...
    <section class="banner text--center">
                <div class="container">
                    <div class="banner__wrapper">
                        <div class="banner__intro text--light">
                            <h1 class="mb--3">Meet the Best Hospital</h1>
                            <p class="mb--5 text--light">We know how large objects will act, but things on a small scale.</p>
                            <ul>
        ...
        <section class="faq text--center py--10 bg--gray">
            <div class="container">
                ...
                <?php if(get_field('faq_item')) : ?>
                        <?php while(the_repeater_field('faq_item')) : ?>
                ...
                <div class="pricing__wrapper">
                    <div class="pricing__items p--3 my--3 bg--light">
                        ...
                        <ul class="includes mb--3">
                            <li>
                                <img src="<?php echo get_template_directory_uri(); ?>/img/list-style-main.png" alt="">
                            ...
                            <li>
                                <img src="<?php echo get_template_directory_uri(); ?>/img/list-style-gray.png" alt="">
